...
<p> Desafio: <strong>APRENDENDO NA PRÁTICA O PARADIGMA DE ORIENTAÇÃO A OBJETOS.</strong><br> Ofertado pela plataforma <strong><a href="https://web.digitalinnovation.one/">DIGITAL INNOVATION ONE</a></strong> <br>
    O objetivo: colocar em prática umas das principais ferramentas da OO: <strong>ABSTRAÇÃO, ENCAPSULAMENTO, HERANÇA E POLIMORFISMO,</strong> através de um projeto Java. </p>
...
<strong>	2.</strong> Criar CLASSES: Bootcamp, Cursos, Mentorias e Devs e relaciona-las <br>
<strong>	3.</strong> As CLASSES Curso, Mentoria e Devs também serão MODELADOS, ou seja, terão seus ATRIBUTOS E MÉTODOS <br> 
<strong>	4.</strong> Ferramentas do PARADIGMA DE ORIENTAÇÃO A OBJETOS (POO): ABSTRAÇÃO, ENCAPSULAMENTO, HERANÇA E POLIMORFISMO <br>
<strong>	5.</strong> Representar CLASSES que foram criadas e relacionadas --> transforma-las em OBJETOS<br>
</p>
